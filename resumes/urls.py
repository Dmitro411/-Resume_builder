...
from .views import resume_detail_view, ResumeSectionCreateView, ResumeListView, ResumeCreateView, ResumeDeleteView, ResumeUpdateView, ResumeSectionUpdateView, ResumeSectionDeleteView
...
urlpatterns = [
    ...
    path('update/', ResumeUpdateView.as_view(), name='resume-update'),
